...
Our results could be limited by the fact that we had to limit our in-depth analysis of the similarity score for men and women to five adjectives (due to technical limitations, we could not do more). In order to confirm our results, we should do this analysis on all of the positive adjectives in our database, to see if other adjectives that could be considered more “feminime”, such as “romantic”, are more associated with women than men, and vice versa for adjectives that could be considered more associated with men. 
